...
public class Service_frag_adapter extends RecyclerView.Adapter<Service_frag_adapter.Service_view_holder> {
    ...
    @NonNull
    @Override
    public Service_frag_adapter.Service_view_holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        return new Service_frag_adapter.Service_view_holder(
                LayoutInflater.from(mCtx).inflate(R.layout.recycle_home_services,parent,false)
        );
    }

    @Override
    public void onBindViewHolder(@NonNull Service_frag_adapter.Service_view_holder holder, int position) {
    ...
    class Service_view_holder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent intent = new Intent(mCtx, ServicePage.class);
